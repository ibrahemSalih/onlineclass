...
const kSignUp =
    TextStyle(color: Colors.white54, fontWeight: FontWeight.bold, fontSize: 17);
const kInputStyle = TextStyle(color: Colors.white54, fontSize: 17);
const kForget =
    TextStyle(color: Colors.white54, fontSize: 14, fontWeight: FontWeight.w500);
const kNoAccount =
